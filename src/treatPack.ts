...
export const treatTemplates: TreatTemplate[] = [
  // Cardiology
  {
    ...
    flavour: "A tin appeared from somewhere. Nobody claimed it. The foil is intact.",
  ...
  },
  {
    ...
    flavour: "The night HCA caught you looking rough and made one anyway. Milk already in. You didn't ask.",
  ...
  // Respiratory
  {
    ...
    flavour: "From the Christmas tin, probably. It is not Christmas. Nobody cares.",
  ...
  },
  {
    ...
    flavour: "The night shift lead has a Nespresso machine nobody officially knows about. Tonight you're in.",
  ...
  // ICU
  {
    ...
    flavour: "The ITU charge nurse made a full pot. You have been included without needing to ask.",
  ...
  },
  {
    ...
    flavour: "Someone's birthday. Carrot cake, very good. They insist on a second slice.",
  ...
  // MAU
  {
    ...
    flavour: "Provenance: unknown. Contents: mostly toffee pennies at this stage, but still.",
  ...
  },
  {
    ...
    flavour: "The ward clerk keeps a stash for emergencies. She has decided this counts.",
  ...
  // COTE (elderly)
  {
    ...
    flavour: "'You look terrible,' says an HCA, handing it to you without further comment. It is correct.",
  ...
  },
  {
    ...
    flavour: "Note attached: 'For the night staff — thank you for everything.' You are the night staff.",
  ...
  // Surgical
  {
    ...
    flavour: "Surgical SpR left it at handover. 'Help yourself,' they said. You will.",
  ...
  },
  {
    ...
    flavour: "The charge nurse keeps a private stash for genuine emergencies. Apparently this qualifies.",
  ...
  // Radiology
  {
    ...
    flavour: "Carrot cake. Extremely good. They will not accept one slice as sufficient.",
  ...
  },
  {
    ...
    flavour: "It is unclear who bought them. It is entirely clear they are the correct biscuit.",
  ...
  // Pharmacy
  {
    ...
    flavour: "'Help yourself,' they say, turning back to the TPN query. You help yourself.",
  ...
  // Estates
  {
    ...
    flavour: "Strong enough to stand a spoon in. Handed over without comment or conditions.",
  ...
  // Generic — any ward
  {
    ...
    flavour: "Sticky note: 'FOR THE NIGHT TEAM — thank you.' You are the night team.",
    consequence: { stamina: 8, score: 20 },
  },
  {
    id: "generic_kettle",
    ...
    flavour: "You didn't ask. They saw you and just handed it over. NHS solidarity, quietly enacted.",
  ...
  },
  {
    ...
    flavour: "Origin unknown. Contents: assorted. Possibly from a grateful discharge. You were not told to ask.",
  ...
  },
  {
    ...
    flavour: "Still sealed. 'They're just going in the bin otherwise,' says the ward clerk.",
